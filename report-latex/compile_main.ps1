<#
PowerShell helper to compile the main LaTeX report.
Uses latexmk in go mode so every run rebuilds the PDF even if cached files exist.
Usage: Open PowerShell in this folder and run: .\compile_main.ps1
#>
...
Write-Output "Compilation finished. Output: main.pdf"