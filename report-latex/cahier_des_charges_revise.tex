...
\begin{itemize}
  ...
  \item Tracking / helpers : `supervision` (SORT/associations) et logique interne de suivi.
  ...
  \item Stockage : base SQLite comme source unique pour historisation.
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{database} : stockage des métriques et métadonnées pour analyse offline.
\end{itemize}
...
\begin{itemize}
  ...
  \item Notifier/Rules Engine qui déclenche alertes (webhook/email) et stocke métriques via SQLite/DB.
