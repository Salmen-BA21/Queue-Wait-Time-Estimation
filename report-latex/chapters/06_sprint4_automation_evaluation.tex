...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|X|}
        ...
        UC-4.1 & As a manager, I want alert payloads dispatched to n8n so that operational staff can be notified automatically. & Define the webhook payload schema, validate it before dispatch, and protect delivery with shared-secret authorization. \\ \hline
        ...
        UC-4.3 & As a manager, I want webhook retries, cooldown handling, and delivery logging so that notification failures are visible and repeated alerts are controlled. & Add retry logic, timeout handling, cooldown checks, and delivery logging for webhook notifications. \\ \hline
