...
The Sprint 3 backlog was organized as a table so both the design foundation and the live monitoring tasks remain traceable, as shown in Table~\ref{tab:sprint3_backlog}.
\begin{table}[!htbp]
    \centering
    \footnotesize
...
\end{figure}
The onboarding workflow starts with the feed setup screen shown in Figure~\ref{fig:sprint3_feed_config}, where the manager prepares a local video source before zone tracing and model selection.
\begin{figure}[H]
    \centering
...
\end{figure}
The staged feed is then confirmed in the review and launch panel presented in Figure~\ref{fig:sprint3_review_panel}.
\begin{figure}[H]
    \centering
